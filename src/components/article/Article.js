    ...
    return(
        <div className="flex justify-end mt-2 mx-8 box-border mb-28 ">
            <div className="flex flex-col p-10 w-1/2 mr-5">
                ...
                <button onClick={() => switchRegister(true)} className="blue-button py-5 self-start text-2xl w-2/5 font-bold get-button flex mt-5 border border-transparent rounded-full text-white bg-the-blue hover:bg-the-blue-focused focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-the-blue-focused" > Get Started</button>
            </div>
