    ...
    return(
        <div className="flex justify-end mt-2 mb-20">
            <div className="flex flex-col p-8">
                ...
                <button onClick={() => switchLogin(true)} className="blue-button p-2 get-button flex mt-2.5 border border-transparent rounded-md text-white bg-the-blue hover:bg-the-blue-focused focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-the-blue-focused" > Get Started</button>
            </div>
