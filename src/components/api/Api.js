  ...
  // console.log(array)
    return (
        ...
        <form onSubmit={submitHandler} className={"backgroundApi flex w-4/5 h-1/6 flex px-8 py-4 justify-around rounded-lg self-center bg-the-purple absolute -top-20"}>
            ...
            />
            <button type="submit" className={"flex blue-button rounded-md self-center h-12 w-1/6 border border-transparent text-white bg-the-blue hover:bg-the-blue-focused focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-the-blue-focused"}>
